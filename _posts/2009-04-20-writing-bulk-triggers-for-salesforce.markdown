...
description: It's exciting to see all of the new members on the Salesforce.com message b...
...
<pre><code class="language-javascript">trigger AddOwnerColor on Account (before insert, before update) {
...
<pre><code class="language-javascript">@isTest
